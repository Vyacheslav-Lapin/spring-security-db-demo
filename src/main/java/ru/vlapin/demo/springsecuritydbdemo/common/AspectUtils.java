...
public class AspectUtils {
  ...
  public <R> R destruct(ProceedingJoinPoint pjp, @NotNull CheckedFunction1<Method, R> method) {
    return method.unchecked().apply(getMethod(pjp).orElseThrow());
  }

  public <A extends Annotation> A getAnnotation(@NotNull Method method, Class<A> aClass) {
